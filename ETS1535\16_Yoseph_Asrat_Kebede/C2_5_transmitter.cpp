...
int main() {
    ...
    cout<<"To know the amount of time need for the transfer, What unit will you be using:\nt for TeraBytes\ng for GigaBytes\nm for MegaBytes\nk for KiloBytes\nb for Bytes ";
    cin>>size_type;
    ...
    switch (size_type) {
        ...
        break;
        default:
        cout<<"Invalid input, please input the correct letter for the unit, maybe check the capslock"<<endl;
        return 0;
    }
    time = (size * size_num) / 960;
    years = time / 31536000; 
    time %= 31536000;
//The time for a month is taken by the average time or number of seconds in a month and not the usual 30 day period.
    months = time / 2628288;
    time %= 2628288;
    weeks = time / 604800;
    time %= 604800;
